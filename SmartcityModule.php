...
class SmartcityModule extends CWebModule {

	private $_assetsUrl;

	private $_version = "v0.1.0";
	private $_versionDate = "10/01/2018";
	private $_keywords = "city,cities, smart city, smart, territory,  module,opensource,CO,communecter";
	private $_description = "Smart City module for CO";
	private $_pageTitle = "Smart City modules & CO Systems";
